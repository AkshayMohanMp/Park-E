...
class slot2 extends StatefulWidget {
  ...
  @override
  State<slot2> createState() => _slot2PageState();
}

class _slot2PageState extends State<slot2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Slot-2 Registeration', style: TextStyle(fontSize:30,color: Colors.black),),
                        ...
                        children: [
                          ...
                          FlatButton(
                            onPressed: () {
                              ...
                              final docUser= FirebaseFirestore.instance.collection('Slot2').doc(Namecontroller.text);
                              docUser.set(data);
                            },
                            child: Text(
                              "Register Slot",
