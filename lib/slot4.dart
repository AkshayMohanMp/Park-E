...
class slot4 extends StatefulWidget {
  ...
  @override
  State<slot4> createState() => _slot4PageState();
}

class _slot4PageState extends State<slot4> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Slot-4 Registeration', style: TextStyle(fontSize:30,color: Colors.black),),
                        ...
                        children: [
                          ...
                          FlatButton(
                            onPressed: () {
                              ...
                              final docUser= FirebaseFirestore.instance.collection('Slot4').doc(Namecontroller.text);
                              docUser.set(data);
                            },
                            child: Text(
                              "Register Slot",
